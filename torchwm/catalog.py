...
This module replaces the previous `torchwm.ui.catalog` and is safe to
...
def _list_available_robotics_envs() -> list[str]:
    ...
    try:
        from torchwm.envs import list_gymnasium_robotics_envs
...
def _list_available_bsuite_ids() -> list[str]:
    ...
    try:
        from torchwm.envs import list_available_bsuite_ids
...
def _list_available_atari_envs() -> list[str]:
    ...
    try:
        from torchwm.envs import list_available_atari_envs
...
def _list_available_dmlab_levels() -> list[str]:
    try:
        from torchwm.envs.dmlab import DMLAB_LEVELS
