...
MODEL_SPECS: dict[str, ModelSpec] = {
    ...
    "dreamer-v1": ModelSpec(
        name="dreamer-v1",
        import_path="torchwm.models.dreamer_v1:DreamerV1",
        config_path="torchwm.configs.dreamer_config:DreamerConfig",
    ...
    "dreamer-v2": ModelSpec(
        name="dreamer-v2",
        import_path="torchwm.models.dreamer_v2:DreamerV2",
        config_path="torchwm.configs.dreamer_config:DreamerConfig",
    ...
    "planet": ModelSpec(
        name="planet",
        import_path="torchwm.models.planet:Planet",
        description="PlaNet agent and planner for image-based control.",
        aliases=("pla_net",),
    ),
    "jepa": ModelSpec(
        name="jepa",
        import_path="torchwm.models.jepa_agent:JEPAAgent",
        config_path="torchwm.configs.jepa_config:JEPAConfig",
        description="JEPA self-supervised visual representation trainer.",
        aliases=("ijepa", "i-jepa"),
    ),
    "iris": ModelSpec(
        name="iris",
        import_path="torchwm.models.iris_agent:IRISAgent",
        config_path="torchwm.configs.iris_config:IRISConfig",
        description="IRIS world model and actor-critic module.",
        aliases=("iris_agent",),
    ),
    "genie": ModelSpec(
        name="genie",
        import_path="torchwm.models.genie:create_genie",
        config_path="torchwm.configs.genie_config:GenieConfig",
        description="Genie generative interactive environment model.",
        aliases=("genie_base",),
    ),
    "genie-small": ModelSpec(
        name="genie-small",
        import_path="torchwm.models.genie:create_genie_small",
        config_path="torchwm.configs.genie_config:GenieSmallConfig",
        description="Smaller Genie variant for development and tests.",
        aliases=("genie_small",),
    ),
    "genie-large": ModelSpec(
        name="genie-large",
        import_path="torchwm.models.genie:create_genie_large",
        description="Large Genie variant.",
        aliases=("genie_large",),
    ),
    "diamond": ModelSpec(
        name="diamond",
        import_path="torchwm.training.train_diamond:DiamondAgent",
        config_path="torchwm.configs.diamond_config:DiamondConfig",
        description="DIAMOND diffusion world model agent for Atari-style control.",
        aliases=("diamond_agent",),
    ),
    "dit": ModelSpec(
        name="dit",
        import_path="torchwm.models.diffusion.DiT:create_dit",
        config_path="torchwm.configs.dit_config:DiTConfig",
    ...
    "modular-rssm": ModelSpec(
        name="modular-rssm",
        import_path="torchwm.models.modular_rssm:create_modular_rssm",
...
ENV_BACKEND_SPECS: dict[str, EnvBackendSpec] = {
    "auto": EnvBackendSpec(
        name="auto",
        factory_path="torchwm.envs:make_env",
...
def _resolve_model_name(name: str) -> str:
    ...
    try:
        ...
        pass
    from torchwm.registry import get_registered_model_spec
...
def list_models() -> list[str]:
    ...
    from torchwm.registry import list_registered_models
...
def list_envs(model: str | None = None) -> list[str] | dict[str, list[str]]:
    ...
    from torchwm.catalog import ENVIRONMENTS_BY_MODEL
