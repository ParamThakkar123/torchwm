...
Use `DreamerConfig.env_backend` for Dreamer-compatible DMC, Gym/Gymnasium, MuJoCo, Gymnasium Robotics, Procgen, BSuite, Brax, and Unity environments. Choose the backend that matches your installed optional dependencies and task source.

```python :class: thebe
from torchwm import DreamerConfig

cfg = DreamerConfig()
# env_backend may be one of: "dmc", "gym", "mujoco", "robotics", "procgen", "bsuite", "brax", or "unity_mlagents"
cfg.env_backend = "dmc"
cfg.env = "walker-walk"
cfg.image_size = 64
cfg.action_repeat = 2
