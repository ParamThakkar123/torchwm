...
from torchwm.memory.planet_memory import Memory
...
class _RestrictedReplayUnpickler(pickle.Unpickler):
    ...
    _ALLOWED_GLOBALS = {
        ...
        ("torchwm.memory.planet_memory", "Episode"),
        ("torchwm.memory.planet_memory", "Memory"),
        ("torchwm.memory.planet_memory", "_identity"),
    }
