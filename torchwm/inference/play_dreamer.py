...
Usage:
    python -m torchwm.inference.play_dreamer --checkpoint path/to/checkpoint.pt --game walker-walk
    python -m torchwm.inference.play_dreamer --checkpoint path/to/checkpoint.pt --record dream.mp4
"""
...
from torchwm.inference.play_base import init_video_recorder, resolve_checkpoint_path
...
# Arrow key codes, matching torchwm/inference/play_base.py.
_ARROW_UP = 0x26
_ARROW_DOWN = 0x28
_ARROW_LEFT = 0x25
_ARROW_RIGHT = 0x27
...
class DreamerPlayer:
    ...
    def __init__(
        ...
        resolved = device or default_device_name()
