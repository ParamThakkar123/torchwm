...
class Dreamer:
    ...
    def from_pretrained(
        ...
        **overrides: Any,
        ...
        obs_shape = checkpoint.get("obs_shape") if isinstance(checkpoint, dict) else None
        action_size = checkpoint.get("action_size") if isinstance(checkpoint, dict) else None
